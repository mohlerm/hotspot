...
OBJS += \
./src/share/vm/asm/assembler.o \
./src/share/vm/asm/codeBuffer.o \
./src/share/vm/asm/register.o 

CPP_DEPS += \
./src/share/vm/asm/assembler.d \
./src/share/vm/asm/codeBuffer.d \
./src/share/vm/asm/register.d 


# Each subdirectory must supply rules for building sources it contributes
src/share/vm/asm/%.o: ../src/share/vm/asm/%.cpp
	@echo 'Building file: $<'
