...
class NoCompile {
  ...
  public static double method1(double count) {
    long start;
    long end;
    if(VERBOSE) System.out.println("> START METHOD NoCompile.method1() for " + Double.toString(count) + " <");
  ...
  //  long start;
  //  long end;
  //  if(VERBOSE) System.out.println("> START METHOD NoCompile.method2() for " + Double.toString(count) + " <");
  //  start = System.nanoTime();
