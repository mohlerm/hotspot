...
While \texttt{mode0} and \texttt{mode1} are similar except for the compile thresholds, \texttt{mode2} consists of a few changes will be described in detail in the following section.
\begin{figure}[h]
  \begin{center}
    \centering
...
\label{s:mode1}
This is doing exactly the same as mode 1 but does not scale the compilation thresholds.
