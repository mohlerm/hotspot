...
In fact the JVM published and distributed by Azul Systems® called Zing® \cite{zing} already offers a similar functionality.
Zing includes a system called ReadyNow!™ \cite{readynow}.
