...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Variation from baseline of all SPECjvm benchmarks}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Variation from baseline of all Octane benchmarks}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Variation from baseline of all SPECjvm benchmarks without intrinsified methods}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Deoptimization variation from baseline of all SPECjvm benchmarks}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Deoptimization variation from baseline of all Octane benchmarks}
